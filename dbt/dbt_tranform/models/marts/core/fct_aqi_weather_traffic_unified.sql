...
aqi_base AS (
    ...
    SELECT
        ...
        argMax(aqiin_observation_count, last_ingested_at) as aqiin_observation_count,
        argMax(openweather_observation_count, last_ingested_at) as openweather_observation_count,
